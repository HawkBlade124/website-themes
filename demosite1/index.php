    ...
    <section id="menu">        
        <div id="menuWrapper" class="wrapperWidth">
            ...
            <div id="appetizers">
                ...
                <div id="appetizersWrapper" class="innerMenuWrapper box-sizing-content d-flex flex-wrap justify-content-between w-100">
            ...
            <div id="entrees">
                <div class="triangleDivider"></div>
                <div id="entreesWrapper" class="innerMenuWrapper box-sizing-content d-flex flex-wrap justify-content-between w-100">
            ...
            <div id="salads">
                <div class="triangleDivider"></div>
                <div id="saladsWrapper" class="innerMenuWrapper box-sizing-content d-flex flex-wrap justify-content-between w-100">                    
            ...
            <div id="drinks">
                <div class="triangleDivider"></div>
                <div id="drinksWrapper" class="innerMenuWrapper box-sizing-content d-flex flex-wrap justify-content-between w-100">
